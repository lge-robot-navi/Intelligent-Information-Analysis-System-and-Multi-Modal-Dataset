...
<!--
	...
	// 상세조회
	function fnSelect(imageFileSq) {
		var url = 'update?imageFileSq=' + imageFileSq;
		location.href = url;
	}
...
<div class="well search-wrap">
	<form:form method="get" action="list" modelAttribute="imageFileInfoEntity" cssClass="form-inline search-form" role="form" autocomplete="off">
		<fieldset>
			<div class="row">
				<div class="col-sm-10">
					<div class="row">
					...
					<div class="row">
		        		<div class="col-sm-6">
							<div class="form-group">
								...
								<label class="select">
									<tags:select id="imageFileTypeCd" name="imageFileTypeCd" group="TA004" cssClass="form-control" value="${imageFileInfoEntity.imageFileTypeCd}">
							...
							<div class="form-group">
								...
								<label class="select">
									<select id="taggingYn" name="taggingYn" class="form-control">
										<option value=""><spring:message code="common.all" /></option>
										<option value="Y" <c:if test="${imageFileInfoEntity.taggingYn eq 'Y'}"> selected</c:if> ><spring:message code="admin.image.imageTagggingY" /></option>
										<option value="N" <c:if test="${imageFileInfoEntity.taggingYn eq 'N'}"> selected</c:if> ><spring:message code="admin.image.imageTagggingN" /></option>
									</select>
									<i></i>
								</label>
							</div>
	...
	<table class="table table-striped table-bordered table-hover" style="table-layout:fixed;">
		...
		<tbody>
			...
			<c:forEach var="item" items="${list}">
				<tr onclick="javascript:fnSelect('${item.imageFileSq}');">
					...
					<div id="bootstrap-wizard-1" class="col-sm-12">
						...
						<div class="tab-content">
							<div class="tab-pane active" id="tab1">
								...
								<div>
									<jsp:include page="/WEB-INF/views/image/imageFileInfo/list-sub.jsp" flush="false"/>
								</div>
							</div>
											...
											<div class="jarviswidget jarviswidget-sortable jarviswidget-color-blueDark" id="wid-id-2" data-widget-togglebutton="false" data-widget-editbutton="false" data-widget-deletebutton="false" data-widget-colorbutton="false" data-widget-fullscreenbutton="false" data-widget-collapsed="false" data-widget-attstyle="jarviswidget-color-blueDark">
												...
												<div>
													<div id="imageAssignDivBody" class="widget-body" style="min-height: 900px; max-height: 1000px;">
														<div>
															<jsp:include page="/WEB-INF/views/image/imageFileInfo/img-list-assign-work.jsp" flush="false"/>
														</div>
													</div>
												</div>
											</div>
	...
	<div class="modal-dialog" style="width: 90%;">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="fileDownloadLabel">Image File Export</h4>
			</div>
				...
				<div class="row">
					<article class="col-sm-12 col-md-12 col-lg-6">
						...
						<div class="jarviswidget jarviswidget-sortable jarviswidget-color-blueDark" id="wid-id-3" data-widget-togglebutton="false" data-widget-editbutton="false" data-widget-deletebutton="false" data-widget-colorbutton="false" data-widget-fullscreenbutton="false" data-widget-collapsed="false" data-widget-attstyle="jarviswidget-color-blueDark">
							...
							<!-- widget div-->
							<div>
								<div id="imageExportDivBody" class="widget-body" style="min-height: 900px; max-height: 1000px;">
									<div>
										<jsp:include page="/WEB-INF/views/image/imageFileInfo/img-list-export.jsp" flush="false"/>
									</div>
								</div>
							</div>
						</div>
