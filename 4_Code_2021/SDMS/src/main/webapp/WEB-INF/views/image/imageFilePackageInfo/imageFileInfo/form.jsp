	...
	function fnCodeSave() {
		...
		if (frm.valid()) {
			if (confirm('<spring:message code="save.isSave" />')) {
				$.ajax({
					type: 'POST',
					url: '${REQUEST_CONTEXT_PATH}/system/code-group/code/form',
					data: frm.serialize(),
...
<div class="well">
	<form:form method="post" action="form" modelAttribute="codeEntity" cssClass="smart-form" role="form">
		<form:hidden path="cdgrpCd" />
	
		<fieldset>
			<div class="row">
				<section class="col col-6">
					<label class="label"><spring:message code="system.code.codeCd" /></label>
					<label class="input">
						<form:input path="codeCd" maxlength="10" cssClass="required" />
					</label>
				</section>
				<section class="col col-6">
					<label class="label"><spring:message code="system.code.codeNm" /></label>
					<label class="input">
			...
			<div class="row">
				<section class="col col-6">
					<label class="label"><spring:message code="system.code.orderNo" /></label>
					<label class="input">
						<form:input path="orderNo" maxlength="4" cssClass="required digits" />
					</label>
				</section>
				<section class="col col-6">
					<label class="label"><spring:message code="system.code.useYn" /></label>
					<label class="select">
			...
			<div class="row">
				<section class="col col-6">
					<label class="label"><spring:message code="system.code.ifCd" /></label>
					<label class="input">
			...
			<section>
				<label class="label"><spring:message code="system.code.codeDs" /></label>
