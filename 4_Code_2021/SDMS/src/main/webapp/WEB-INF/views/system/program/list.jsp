...
<!--
	...
	ul.fancytree-container { min-height: 292px; }
	ul.fancytree-container { border: none; }

	#tree .fancytree-expander { padding-right: 1.3em; }

	#fancytree-drop-marker { background-color: orange !important; }
	
	/* iconpicker */
	.iconpicker { padding: 6px 12px; }
-->
</style>
		...
		_tree.fancytree({
			...
			activate: function(event, data) {
 			...
 			source: function() {
 				...
 				// 초기 데이터를 호출한다.
 				var children;
 				getChildren(rootKey, function(data) { console.log('data => ', data); children = data; });
 				
				var obj = [{ key: rootKey, title: "ROOT", folder: true, expanded: true, children: children }];
