		...
		<fieldset>
			<div class="row">
				<section class="col col-6">
					<label class="label"><spring:message code="system.admin-group.adminGrpId" /></label>
					<label class="input">
						<form:input path="adminGrpId" maxlength="10" cssClass="required" readonly="true" />
					</label>
				</section>
				<section class="col col-6">
					<label class="label"><spring:message code="system.admin-group.adminGrpNm" /></label>
					<label class="input">
						<form:input path="adminGrpNm" maxlength="100" cssClass="required" />
					</label>
				</section>
				<section class="col col-6">
					<label class="label"><spring:message code="system.admin-group.useYn" /></label>
					<label class="select">
			...
			<section>
				<label class="label"><spring:message code="system.admin-group.adminGrpDs" /></label>
	...
	<div class="row margin-top-10">
		<div class="col-sm-12">
			<a href="javascript:programSave();" class="btn btn-sm btn-primary pull-right" role="button">
				<i class="fa fa-plus"></i> <span><spring:message code="common.save" /></span></a>
		</div>
	</div>
</custom:auth>
<!-- // button -->
