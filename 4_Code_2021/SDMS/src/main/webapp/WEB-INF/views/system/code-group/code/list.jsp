...
<div class="table">
	...
	<!-- 
		...
		<thead>
			<tr>
				<th><spring:message code="system.code.cdgrpCd" /></th>
				<th><spring:message code="system.code.codeNm" /></th>
				<th><spring:message code="system.code.codeDs" /></th>
				<th><spring:message code="system.code.ifCd" /></th>
				<th><spring:message code="system.code.orderNo" /></th>
				<th><spring:message code="system.code.useYn" /></th>
			</tr>
		</thead>
		...
		<custom:auth authUrl="/system/code-group/" type="CREATE">
			<div class="btn-group">
				<a class="btn btn-sm btn-primary" href="javascript:getCodeForm();" role="button">
					<i class="fa fa-plus"></i> <spring:message code="common.insert" />
				</a>
			</div>
		</custom:auth>
	</div>
