...
public class BaseEntity {
	...
	private String cStartDt;                 // date of start for search (검색시작일)
	private String cEndDt;                   // date of end for search (검색종료일)
	 ...
	 * @param startDt the startDt to set
	 */
	public void setCStartDt(String cStartDt) {
