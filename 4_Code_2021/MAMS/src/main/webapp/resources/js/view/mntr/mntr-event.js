...
function clickAllNormalEvent() {
    console.log("전체정상상황...");
    appbody.events.forEach(function (event) {
        if (event.fbNeed == "Y") {
...
// 이상상황 버튼 클릭 시
function clickAbnormalEvent(evt) {
    console.log("이상상황...");
    console.log("event", evt);
    var param = {
        topic: getTopic(topicEtriHil),
...
//# sourceMappingURL=mntr-event.js.map