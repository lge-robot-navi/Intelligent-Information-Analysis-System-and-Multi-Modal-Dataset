...
function initOverlayMap(map, area, moveAgent) {
    ...
    if (area === "ph")
        historicalOverlay = new google.maps.GroundOverlay("/monitoring/resources/images/pohang-map-13630.png", imageBounds, overlayOpts);
    // 포항
    else
        historicalOverlay = new google.maps.GroundOverlay("/monitoring/resources/images/gwangju-map-2048.png", imageBounds, overlayOpts); //광주
...
//# sourceMappingURL=mntr-map-overlay.js.map