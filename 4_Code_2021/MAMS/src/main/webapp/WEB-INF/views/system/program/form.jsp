...
<div class="well">
  <form:form id="program-form" method="post" action="form" cssClass="smart-form" modelAttribute="programEntity">
    ...
    <fieldset>
      <section>
        <label class="label">
          <spring:message code="system.program.upperPgmNm" /></label>
        <label class="input">
      ...
      <section>
        <label class="label">
          <spring:message code="system.program.pgmNm" /></label>
        <label class="input">
      ...
      <div class="row">
        <section class="col col-6">
          <label class="label">
            <spring:message code="system.program.rankNo" /></label>
          <label class="input">
        ...
        <section class="col col-6">
          <label class="label">
            <spring:message code="system.program.useYn" /></label>
          <label class="select">
      ...
      <section>
        <label class="label">
          <spring:message code="system.program.pgmTp" /></label>
      ...
      <div class="row">
        <section class="col col-2">
          <label class="label">
            <spring:message code="system.program.iconDs" /></label>
          <label class="input">
            <button id="iconDs" name="iconDs" class="btn btn-default" data-iconset="fontawesome" data-rows="5" data-cols="12"
        ...
        <section id="urlDsWrap" class="col col-10">
          <label class="label">
            <spring:message code="system.program.urlDs" /></label>
          <label class="input">
