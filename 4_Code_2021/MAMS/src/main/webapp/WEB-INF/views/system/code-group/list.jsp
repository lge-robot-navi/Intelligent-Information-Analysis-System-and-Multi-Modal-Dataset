...
<div class="table-responsive">
  <table class="table table-striped table-bordered table-hover">
    <thead>
      <tr>
        <th>
          <spring:message code="system.code-group.cdgrpCd" />
        </th>
        <th>
          <spring:message code="system.code-group.cdgrpNm" />
        </th>
        <th>
          <spring:message code="system.code-group.orderNo" />
        </th>
        <th>
          <spring:message code="system.code-group.useYn" />
        </th>
      </tr>
    </thead>
    <tbody>
