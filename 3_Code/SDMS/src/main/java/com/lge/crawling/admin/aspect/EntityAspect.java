...
import com.lge.crawling.admin.common.web.entity.BaseEntity;
...
public class EntityAspect {
	 ...
	 */
	@Pointcut("execution( * com.lge.crawling.admin..*Controller.*(..))")
...
//		logger.error("[EXCEPTION] : {}.{}()", sig.getDeclaringType(), sig.getName());
