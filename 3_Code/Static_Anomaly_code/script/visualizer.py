...
class Visualizer():
    ...
    def __init__(self, opt):
        ...
        self.img_dir = os.path.join(opt.outf, 'train', 'images')
        self.tst_img_dir = os.path.join(opt.outf, 'test', 'images')
        ...
        # --
        # Log file.
        self.log_name = os.path.join(opt.outf, 'train', 'loss_log.txt')
    ...
    def save_current_images(self, epoch, reals, fakes):
        ...
        #vutils.save_image(reals, '%s/%03d_reals.png' % (self.img_dir, epoch + 1), normalize=True)
        #vutils.save_image(fakes, '%s/%03d_fakes.png' % (self.img_dir, epoch + 1), normalize=True)
        vutils.save_image(reals, '%s/%03d_reals.png' % (self.img_dir, epoch + 1), normalize=True)
        vutils.save_image(fakes, '%s/%03d_fakes.png' % (self.img_dir, epoch + 1), normalize=True)
        # vutils.save_image(fixed, '%s/fixed_fakes_%03d.png' %(self.img_dir, epoch+1), normalize=True)
