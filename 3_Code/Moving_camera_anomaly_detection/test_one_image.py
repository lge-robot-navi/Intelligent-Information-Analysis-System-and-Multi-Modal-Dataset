...
# vutils.save_image(real_cpu,'val_real_samples.png',normalize=False)
# vutils.save_image(input_cropped.data,'val_cropped_samples.png',normalize=False)
# vutils.save_image(recon_image.data,'val_recon_samples.png',normalize=False)
p=0
l1=0
l2=0
